...
struct ProducerHomeView: View {
    ...
    init(swiftDataService: SwiftDataService) {
        _viewModel = State(initialValue: ProducerHomeViewModel(swiftDataService: swiftDataService))
    }
    ...
    private var actionsSection: some View {
        VStack(spacing: AppTheme.Spacing.md) {
            // AI Copilot Button
            NavigationLink(destination: CopilotChatView()) {
                ActionCard(
            ...
            // Diagnosis Button
            if let user = viewModel.userProfile {
                NavigationLink(destination: DiagnosisCameraView(user: user)) {
                    ActionCard(
                        icon: "camera.fill",
...
#Preview {
    ...
    ProducerHomeView(swiftDataService: service)
